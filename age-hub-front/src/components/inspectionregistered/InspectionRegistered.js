...
const InspectionRegistered = () => {

    const [inspection, setInspection] = useState({});

    useEffect(() => {
        const params = {
            jobControlNumber: localStorage.getItem("newInspection"),
        };
        axios.get("http://localhost:8080/findByJobControlNumber", { params }).then((response) => {
    ...
    return (
        <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 className="h1"> Inspection Added! {inspection.jobControlNumber} {inspection.type} </h1>
            </div>
...
export default InspectionRegistered;